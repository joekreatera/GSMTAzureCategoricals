...
class SSMLKVForestPredictor(BaseEstimator, ClassifierMixin):
    ...
    def import_model(self, parameters=None, dataset=None, nodes=None, categoryMap=[], folder=""):
        ...
        # print("Node hyper params: " , self.node_hyper_params)
    ...
    def save_model(self, export_folder):
        ...
        if("usec_cols"  in self.node_hyper_params ):
            self.node_hyper_params.pop("usec_cols") # this is not needed
